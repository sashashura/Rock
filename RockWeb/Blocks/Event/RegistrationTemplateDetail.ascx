                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <Rock:FinancialGatewayPicker ID="fgpFinancialGateway" runat="server" Label="Financial Gateway"
                                        Help="The financial gateway to use for processing registration payments." ShowInactive="true" ShowAllGatewayComponents="false" AutoPostBack="true" OnSelectedIndexChanged="fgpFinancialGateway_SelectedIndexChanged" />
