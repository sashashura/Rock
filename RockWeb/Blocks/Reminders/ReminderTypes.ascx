...
<asp:UpdatePanel ID="upnlContent" runat="server">
    <ContentTemplate>
        ...
        <Rock:ModalDialog ID="mdEditReminderType" Title="Edit Reminder" runat="server" ValidationGroup="EditReminderType" OnSaveClick="mdEditReminderType_SaveClick" CancelLinkVisible="true">
            <Content>
