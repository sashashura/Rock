...
", hfSelectedItems.ClientID, pnlEntry.ClientID );
        ...
        protected void btnConfirm_Click( object sender, EventArgs e )
        {
            ...
            // ShowNotification( NotificationBoxType.Success, string.Format( "{0} {1} successfully updated.)", connectionRequests.Count.ToString( "N0" ), connectionRequests.Count > 1 ? "people were" : "person was" ) );
