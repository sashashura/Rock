...
import EditPanel from "./LocationDetail/editPanel.partial";
import ViewPanel from "./LocationDetail/viewPanel.partial";
import { getSecurityGrant, provideSecurityGrant, refreshDetailAttributes, useConfigurationValues, useInvokeBlockAction } from "@Obsidian/Utility/block";
import { debounce } from "@Obsidian/Utility/util";
import { NavigationUrlKey } from "./LocationDetail/types";
...
export default defineComponent({
    ...
    setup() {
        ...
        const locationEditBag = ref<LocationBag | null>(null);
