...
";
        ...
        private void AddReminderListPage()
        {
            ...
            RockMigrationHelper.AddPageRoute( SystemGuid.Page.REMINDER_LIST, "reminders/{EntityTypeId}/{TagId}" );
            RockMigrationHelper.AddPageRoute( SystemGuid.Page.REMINDER_LIST, "reminders/{EntityTypeId}/{TagId}/{EntityId}" );
