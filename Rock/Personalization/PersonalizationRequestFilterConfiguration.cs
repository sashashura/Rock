...
namespace Rock.Personalization
{
    ...
    public class PersonalizationRequestFilterConfiguration
    {
        ...
        public PreviousActivityRequestFilter PreviousActivityRequestFilter { get; set; }

        /// <summary>
        /// Gets or sets the device type request filter.
        /// </summary>
        /// <value>The device type request filter.</value>
        public DeviceTypeRequestFilter DeviceTypeRequestFilter { get; set; }
        ...
        public List<QueryStringRequestFilter> QueryStringRequestFilters { get; set; }
