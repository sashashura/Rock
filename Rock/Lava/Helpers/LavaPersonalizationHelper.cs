    ...
    internal static class LavaPersonalizationHelper
    {
            ...
            //ILavaRenderContext context )
        {
            ...
            else
            {
                ...
                //currentPerson = LavaHelper.GetCurrentPerson( context );
        ...
        /// </summary>
        /// <param name="personReference">A reference that can be resolved to a person object.</param>
        /// <param name="context"></param>
        /// <returns></returns>
        public static List<int> GetPersonalizationSegmentIdListForPerson( Person person, RockContext rockContext )
            //object personReference, ILavaRenderContext context )
        {
            ...
            else
            {
                ...
                personSegmentIdList = segmentService.GetPersonAliasPersonalizationSegmentQuery()
