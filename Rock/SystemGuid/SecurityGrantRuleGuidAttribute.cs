...
{
    /// <summary>
    /// Rock Guid attribute to be used for <see cref="Rock.Security.SecurityGrantRule"/>
    /// </summary>
    /// /// <para>
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SecurityGrantRuleGuidAttribute"/> class.
        /// </summary>
        /// <param name="guid">The unique identifier.</param>
        public SecurityGrantRuleGuidAttribute( string guid )
            : base( guid )
        {
        }
    }
